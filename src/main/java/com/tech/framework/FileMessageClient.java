...
public class FileMessageClient {
	public static void main(String[] args) throws Exception {
		...
		byte file_suffix1 = file_suffix_list.get(1);
...
//		content_byte[3] = file_suffix1;
//		System.arraycopy(file_len, 0, content_byte, 4, 4);
//		System.arraycopy(file_content, 0, content_byte, 8, file_content.length);
//		System.arraycopy(file1_len, 0, content_byte, 8 + file_content.length, 4);
//		System.arraycopy(file_content1, 0, content_byte, 8 + file_content.length + 4, file_content1.length);
		content_byte[0] = 3;
		content_byte[1] = 1;
		content_byte[2] = 1;
